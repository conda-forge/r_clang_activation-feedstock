...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r_clang_activation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r_clang_activation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r_clang_win-64
# for installing globally
pixi global install r_clang_win-64
```
...
It is possible to list all of the versions of `r_clang_win-64` available on your platform:
...
```
pixi search r_clang_win-64 --channel conda-forge
```
